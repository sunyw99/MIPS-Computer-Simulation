module InstructionMem(instr, pc, reset);
    ...
    always @(reset) begin
        if (reset) begin
            ...
            memory[8] = 32'b00010010001100100000000000001001; //beq $s1, $s2, error0 nop
            memory[9] = 32'b10001100000100010000000000000100; //lw $s1, 4($zero)
            memory[10]= 32'b00110010001100100000000001001000; //andi $s2, $s1, 0x48 nop
            ...
            memory[13] =32'b00010010000100110000000000001010; //beq $s0, $s3, error2 nop nop
